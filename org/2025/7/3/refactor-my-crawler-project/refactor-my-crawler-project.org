...
后来公司的 vul 网站更新了，增加了 v25 的 cve 状态维护。安全团队人员有离职，又更新了新功能。我在自已调试看文档的过程中遇
到了不少的错误，逐渐失去了耐心，想到自己写的 python 代码很初级，都写在了一个文件里面。

又想到，python 如些的常用，我之前写的 python 还没有一个博客记录自己的一点编程经验。与安全部的同事沟通，他们也不愿花时间
和我一起调试。那这一次就下大一点力度，把 python 写的更高级一点。
