...
## fix/Round 1：freezable 等待 {#fix-round-1-freezable-等待}
...
## 内核 signal-wakeup 机制 {#内核-signal-wakeup-机制}
...
## 内核 task-freeze 机制 {#内核-task-freeze-机制}
...
## Round 1 的 livelock 问题 {#round-1-的-livelock-问题}
...
## fix/Round 2：syscall restart {#fix-round-2-syscall-restart}
...
## fix/Round 3：syscall restart 2 {#fix-round-3-syscall-restart-2}
...
## fix/uos：4.19 上的 fix {#fix-uos-4-dot-19-上的-fix}
...
## elfverify 的 freezable {#elfverify-的-freezable}
...
## freeze 机制的重写（v6.1） {#freeze-机制的重写-v6-dot-1}
...
而经过重写之后的\__wait_event_freezable()也变成了：
...
## fix/Round 4：最终 fix {#fix-round-4-最终-fix}
