...
lastmod = 2025-03-24T14:27:12+08:00
tags = ["emacs"]
...
### 设置 fcitx5 的输入法切换方法 {#设置-fcitx5-的输入法切换方法}

这个软件的配置文件是：~/.config/fcitx5/ ，这里面关于输入法切换的快捷键都要设置成空的。如图：

{{< figure src="https://r2.guolongji.xyz/allinaent/2025/03/9249e1aa5a0f97d6234bb3d4619d2e64.png" >}}

而在 ~/.local/share/fcitx5/rime/default.custom.yaml 当中：

```nil
ascii_composer/switch_key:
    Caps_Lock: commit_code
    # Shift_L: inline_ascii             # 会导致emacs的快捷键无法使用
    Shift_L: commit_code
    Shift_R: commit_code
